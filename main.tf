...
resource "local_file" "FirstProjectKeyPEM" {
  content  = tls_private_key.FirstProjectKey.private_key_pem
  filename = "FirstProjectKey.pem"
}

resource "local_file" "FirstProjectKeyPPK" {
  content  = tls_private_key.FirstProjectKey.private_key_openssh
  filename = "FirstProjectKey.ppk"
}
